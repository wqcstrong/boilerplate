...
import { siderRoutes } from '@/routes/config';
import type { SiderRoute } from '@/routes/config';
...
function generateMenu(route: SiderRoute) {
  ...
  return (
    ...
    >
      <div className="layout-sidebar">
        ...
        >
          {siderRoutes.map((route) => generateMenu(route))}
        </Menu>
        <p
